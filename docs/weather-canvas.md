...
- `watercolors-6/src/script.js:1980-2105` contains an explicit, running engineering log of hypotheses and results — e.g. testing whether Voronoi noise would improve "brushstrokes", evaluating multi-layer FBO compositing for clouds, and comparing color-space parameterizations (hue vs. saturation vs. brightness).
